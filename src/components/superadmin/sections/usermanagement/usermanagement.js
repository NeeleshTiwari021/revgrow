...
const UserManagement = () => {
    return (
            <div className=' flex flex-col gap-4 mt-4 p-4'>
                ...
                <button className=' px-3 py-1 rounded-xl border-2 border-green-600 text-green-600 hover:bg-green-600 transition-all duration-300 hover:text-white'>User Report</button>
                <button className=' px-3 py-1 rounded-xl border-2 border-green-600 text-green-600 hover:bg-green-600 transition-all duration-300 hover:text-white'>Group Permission</button>
                </div>
